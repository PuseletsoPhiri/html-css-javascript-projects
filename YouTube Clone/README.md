...
A front-end clone of the YouTube homepage built using pure HTML and CSS. This project focuses on replicating layout and styling while practicing responsive design techniques—without any JavaScript.
